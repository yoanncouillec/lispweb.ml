...
OCB_FLAGS   = -use-ocamlfind -use-menhir -I src -I src/eval -I src/parse -I src/main -tag thread -r -package unix -package ssl -package str -package curl -package ISO8601# uses menhir
